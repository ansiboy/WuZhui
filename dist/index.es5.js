                            ...
                            function() {
                                ...
                                _createClass(Control, [{
                                    ...
                                    value: function appendChild(child, index) {
                                        ...
                                        var childElement;
                                        if (child instanceof Control) childElement = child.element;
                                ...
                                _createClass(DataSourcePagingBar, [{
                                    ...
                                    value: function createPagingButton(container) {
                                        ...
                                        var result = {
                                            ...
                                            set active(value) {
                                                ...
                                                button.href = 'javascript:';
                                                if (pagerSettings.buttonClassName) this.setClassName(pagerSettings.buttonClassName);
                                                else this.setClassName(null);
                                            },
                                    ...
                                    value: function createTotalLabel() {
                                        ...
                                        return {
                                            ...
                                            set visible(value) {
                                                if (value == true) totalElement.style.display = 'block';
                                                else totalElement.style.display = 'node';
                                            }
                            ...
                            function(_DataControlField_1$G) {
                                ...
                                function GridViewEditableCell(field, dataItem, valueType) {
                                    ...
                                    if (!_this._valueType) {
                                        ...
                                        if (value instanceof Date) _this._valueType = 'date';
                                        else _this._valueType = _typeof(value);
                                    }
                            ...
                            function(_GridViewCell) {
                                ...
                                _createClass(GridViewDataCell, [{
                                    ...
                                    value: function render(dataItem) {
                                        ...
                                        var text;
                                        if (value == null) text = this.nullText;
                                        else if (this.dataFormatString) text = this.formatValue(this.dataFormatString, value);
                                        else text = "".concat(value);
                                    ...
                                    value: function formatValue(format, arg) {
                                        ...
                                        for (var i = 0;;) {
                                            ...
                                            if (arg instanceof Date) result = result + this.formatDate(arg, argFormat);
                                            else if (arg instanceof Number || typeof arg == 'number') result = result + this.formatNumber(arg, argFormat);
                                            else result = result + arg.toString();
                                            i = close + 1;
                                        }
