  ...
  var GridView = /*#__PURE__*/function (_wuzhui$Control2) {
    ...
    function GridView(params) {
      ...
      for (var i = 0; i < _this7._columns.length; i++) {
        ...
        column.gridView = _assertThisInitialized(_this7);
      }
      ...
      _this7.selectArguments = _this7.pagingBar ? _this7.pagingBar.selectArguments : new wuzhui.DataSourceSelectArguments();

      _this7.dataSource.select(_this7.selectArguments);
    ...
    _createClass(GridView, [{
      ...
      value: function createPagingBar(pagerSettings) {
        ...
        this.pagingBar = new wuzhui.NumberPagingBar({
      ...
      value: function appendEmptyRow() {
        ...
        wuzhui.fireCallback(this.rowCreated, this, {
          row: this._emtpyRow
        });
      }
    }, {
...
(function (wuzhui) {
      ...
      value: function init(dataSource, selectArguments) {
        ...
        if (dataSource) {
          dataSource.selected.add(function (source, args) {
            pagingBar.pageSize = _this9._selectArguments.maximumRows;
  ...
  var StaticNumberPagingBar = /*#__PURE__*/function (_PagingBar2) {
    ...
    function StaticNumberPagingBar(params) {
      ...
      _classCallCheck(this, StaticNumberPagingBar);

      if (!params.loadData) throw wuzhui.Errors.argumentNull('loadData');
      if (!params.element) throw wuzhui.Errors.argumentNull('element');
      var pagerSettings = Object.assign({
        pageButtonCount: 10,
        firstPageText: '<<',
      ...
      _this12.numberButtons = new Array();
      _this12.createButton = _this12.createPagingButton;
      _this12.createLabel = _this12.createTotalLabel;
      var buttonContainer = pagerSettings.buttonContainerWraper ? document.createElement(pagerSettings.buttonContainerWraper) : document.createElement('div');
      buttonContainer.className = pagerSettings.buttonContainerClassName || "buttons";

      _this12.element.appendChild(buttonContainer);

      _this12.createPreviousButtons(buttonContainer);

      _this12.createNumberButtons(buttonContainer);

      _this12.createNextButtons(buttonContainer);

      if (_this12.pagerSettings.showTotal) {
        _this12.totalElement = _this12.createLabel();
        _this12.totalElement.visible = false;
      }

      _this12.init(null, params.selectArguments);

      return _this12;
    }

    _createClass(StaticNumberPagingBar, [{
      key: "createPagingButton",
      value: function createPagingButton(container) {
        var _this13 = this;
      ...
      value: function createNumberButtons(buttonContainer) {
        ...
        this.numberButtons.forEach(function (btn) {
          btn.onclick = function () {
            return StaticNumberPagingBar.on_buttonClick(btn, pagingBar);
          };
        });
      }
    }, {
...
})(wuzhui || (wuzhui = {})); /// <reference path="../Control.ts"/>
    ...
    function GridViewDataCell(params) {
      ...
      if (p.render) {
        _this14.render = function (dataItem) {
          return p.render.apply(_assertThisInitialized(_this14), [dataItem, _this14.element]);
        };
      }
  ...
  var GridViewHeaderCell = /*#__PURE__*/function (_wuzhui$Control4) {
    ...
    function GridViewHeaderCell(field) {
      ...
      if (field.sortExpression) {
        ...
        _this15._iconElement.innerHTML = _this15.toSortHTML;
    ...
    _createClass(GridViewHeaderCell, [{
      ...
      value: function handleSort() {
        ...
        wuzhui.fireCallback(this.sorting, this, {
          sortType: sortType
        });
        ...
        return this.field.gridView.dataSource.select(selectArguments).then(function () {
          ...
          wuzhui.fireCallback(_this16.sorted, _this16, {
            sortType: sortType
          });
        });
      }
...
})(wuzhui || (wuzhui = {})); /// <reference path="DataControlField.ts"/>
  ...
  var GridViewEditableCell = /*#__PURE__*/function (_wuzhui$GridViewDataC) {
    ...
    function GridViewEditableCell(field, dataItem, valueType) {
      ...
      if (!_this17._valueType) {
        ...
        if (value instanceof Date) _this17._valueType = 'date';else _this17._valueType = _typeof(value);
      }
...
//# sourceMappingURL=wuzhui.js.map
